...
def main(collection_id, pubdir, lab_publication):
...
if __name__ == '__main__':
    ...
    # Fetch lab collection
    main("BVV46CMR", sys.argv[1], lab_publication=True)

    # Fetch external collection
    main("MUQ72FZG", sys.argv[1], lab_publication=False)
